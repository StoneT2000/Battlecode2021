...
public class Constants {
        ...
        // public static final int[][] BFS20 = { { 0, 0 }, { 1, 0 }, { 0, -1 }, { -1, 0
        // }, { 0, 1 }, { 2, 0 }, { 1, -1 },
        // { 0, -2 }, { -1, -1 }, { -2, 0 }, { -1, 1 }, { 0, 2 }, { 1, 1 }, { 3, 0 }, {
        // 2, -1 }, { 1, -2 }, { 0, -3 },
        // { -1, -2 }, { -2, -1 }, { -3, 0 }, { -2, 1 }, { -1, 2 }, { 0, 3 }, { 1, 2 },
        // { 2, 1 }, { 4, 0 }, { 3, -1 },
        // { 2, -2 }, { 1, -3 }, { 0, -4 }, { -1, -3 }, { -2, -2 }, { -3, -1 }, { -4, 0
        // }, { -3, 1 }, { -2, 2 },
        // { -1, 3 }, { 0, 4 }, { 1, 3 }, { 2, 2 }, { 3, 1 }, { 4, -1 }, { 3, -2 }, { 2,
        // -3 }, { 1, -4 }, { -1, -4 },
        // { -2, -3 }, { -3, -2 }, { -4, -1 }, { -4, 1 }, { -3, 2 }, { -2, 3 }, { -1, 4
        // }, { 1, 4 }, { 2, 3 },
        // { 3, 2 }, { 4, 1 }, { 4, -2 }, { 3, -3 }, { 2, -4 }, { -2, -4 }, { -3, -3 },
        // { -4, -2 }, { -4, 2 },
        // { -3, 3 }, { -2, 4 }, { 2, 4 }, { 3, 3 }, { 4, 2 } };
        // public static final int[][] BFS30 = { { 0, 0 }, { 1, 0 }, { 0, -1 }, { -1, 0
        // }, { 0, 1 }, { 2, 0 }, { 1, -1 },
        // { 0, -2 }, { -1, -1 }, { -2, 0 }, { -1, 1 }, { 0, 2 }, { 1, 1 }, { 3, 0 }, {
        // 2, -1 }, { 1, -2 }, { 0, -3 },
        // { -1, -2 }, { -2, -1 }, { -3, 0 }, { -2, 1 }, { -1, 2 }, { 0, 3 }, { 1, 2 },
        ...
        // { 2, -2 }, { 1, -3 }, { 0, -4 }, { -1, -3 }, { -2, -2 }, { -3, -1 }, { -4, 0
        // }, { -3, 1 }, { -2, 2 },
        // { -1, 3 }, { 0, 4 }, { 1, 3 }, { 2, 2 }, { 3, 1 }, { 5, 0 }, { 4, -1 }, { 3,
        // -2 }, { 2, -3 }, { 1, -4 },
        // { 0, -5 }, { -1, -4 }, { -2, -3 }, { -3, -2 }, { -4, -1 }, { -5, 0 }, { -4, 1
        // }, { -3, 2 }, { -2, 3 },
        // { -1, 4 }, { 0, 5 }, { 1, 4 }, { 2, 3 }, { 3, 2 }, { 4, 1 }, { 5, -1 }, { 4,
        // -2 }, { 3, -3 }, { 2, -4 },
        // { 1, -5 }, { -1, -5 }, { -2, -4 }, { -3, -3 }, { -4, -2 }, { -5, -1 }, { -5,
        // 1 }, { -4, 2 }, { -3, 3 },
        // { -2, 4 }, { -1, 5 }, { 1, 5 }, { 2, 4 }, { 3, 3 }, { 4, 2 }, { 5, 1 }, { 5,
        // -2 }, { 4, -3 }, { 3, -4 },
        // { 2, -5 }, { -2, -5 }, { -3, -4 }, { -4, -3 }, { -5, -2 }, { -5, 2 }, { -4, 3
        // }, { -3, 4 }, { -2, 5 },
        // { 2, 5 }, { 3, 4 }, { 4, 3 }, { 5, 2 } };
}
